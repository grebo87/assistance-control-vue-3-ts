...
<template>
    <form class="row g-3 " @submit.prevent="onSubmit" >
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="identification_number" name="identification_number" v-model="form.identification_number">
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" v-model="form.date_of_birth">
        ...
        <div class="col-12">
            <router-link :to="{ name: 'personal'}" class="btn btn-light  me-2">
                Cancelar
            </router-link> 
